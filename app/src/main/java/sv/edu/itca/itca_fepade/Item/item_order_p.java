...
public class item_order_p  extends RecyclerView.Adapter<item_order_p.OrderViewHolder> {

    private List<JSONObject> itemsList;
    private Context context;

    public item_order_p(Context context, List<JSONObject> itemsList) {
    ...
    @NonNull
    @Override
    public item_order_p.OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.item_order_p, parent, false);
        return new item_order_p.OrderViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(@NonNull item_order_p.OrderViewHolder holder, int position) {
        try {
